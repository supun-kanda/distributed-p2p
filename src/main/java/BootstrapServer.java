        ...
        try
        {
            ...
            while(true)
            {
                ...
                if (command.equals("REG")) {
                    ...
                    if (nodes.size() == 0) {
                        reply += "0";
                        System.out.println("################## Adding Node ################ " + ip + " " + port + " " + username);
                    ...
                    DatagramPacket dpReply = new DatagramPacket(reply.getBytes() , reply.getBytes().length , incoming.getAddress() , port);
                    System.out.println("################## Send Reply ################ " + dpReply.getData()[0] + " " + dpReply.getAddress() + " " + port);
                    sock.send(dpReply);
